...
const palettes = {
  ...
  "light": ['hsla(18, 100%, 55%, 1)', 'hsla(0, 0%, 99%, 0)', 'hsla(0, 0%, 99%, 0.25)', 'hsla(0, 0%, 99%, 0.5)', 'hsla(0, 0%, 99%, 0.75)', 'hsla(0, 0%, 99%, 1)', 'hsla(4, 11%, 93%, 1)', 'hsla(8, 22%, 88%, 1)', 'hsla(12, 33%, 82%, 1)', 'hsla(16, 44%, 77%, 1)', 'hsla(20, 56%, 72%, 1)', 'hsla(24, 67%, 66%, 1)', 'hsla(28, 78%, 61%, 1)', 'hsla(32, 89%, 55%, 1)', 'hsla(36, 100%, 50%, 1)', 'hsla(0, 15%, 15%, 1)', 'hsla(0, 15%, 10%, 1)', 'hsla(0, 14%, 10%, 0.75)', 'hsla(0, 14%, 10%, 0.5)', 'hsla(0, 14%, 10%, 0.25)', 'hsla(0, 14%, 10%, 0)', 'hsla(18, 100%, 63%, 1)']
  ,
  "dark": ['hsla(18, 100%, 58%, 1)', 'hsla(0, 0%, 12%, 0)', 'hsla(0, 0%, 12%, 0.25)', 'hsla(0, 0%, 12%, 0.5)', 'hsla(0, 0%, 12%, 0.75)', 'hsla(0, 0%, 12%, 1)', 'hsla(4, 11%, 16%, 1)', 'hsla(8, 22%, 20%, 1)', 'hsla(12, 33%, 25%, 1)', 'hsla(16, 44%, 29%, 1)', 'hsla(20, 56%, 33%, 1)', 'hsla(24, 67%, 37%, 1)', 'hsla(28, 78%, 42%, 1)', 'hsla(32, 89%, 46%, 1)', 'hsla(36, 100%, 50%, 1)', 'hsla(0, 15%, 93%, 1)', 'hsla(0, 15%, 95%, 1)', 'hsla(0, 15%, 95%, 0.75)', 'hsla(0, 15%, 95%, 0.5)', 'hsla(0, 15%, 95%, 0.25)', 'hsla(0, 15%, 95%, 0)', 'hsla(18, 100%, 47%, 1)']
  ,
  "light_accent": ['hsla(12, 33%, 82%, 1)', 'hsla(18, 100%, 50%, 0)', 'hsla(18, 100%, 50%, 0.25)', 'hsla(18, 100%, 50%, 0.5)', 'hsla(18, 100%, 50%, 0.75)', 'hsla(18, 100%, 50%, 1)', 'hsla(18, 100%, 52%, 1)', 'hsla(18, 100%, 53%, 1)', 'hsla(18, 100%, 55%, 1)', 'hsla(18, 100%, 57%, 1)', 'hsla(18, 100%, 58%, 1)', 'hsla(18, 100%, 60%, 1)', 'hsla(18, 100%, 62%, 1)', 'hsla(18, 100%, 63%, 1)', 'hsla(18, 100%, 65%, 1)', 'hsla(250, 50%, 95%, 1)', 'hsla(250, 50%, 95%, 1)', 'hsla(249, 52%, 95%, 0.75)', 'hsla(249, 52%, 95%, 0.5)', 'hsla(249, 52%, 95%, 0.25)', 'hsla(249, 52%, 95%, 0)', 'hsla(32, 89%, 55%, 1)']
  ,
  "dark_accent": ['hsla(32, 89%, 46%, 1)', 'hsla(18, 100%, 41%, 0)', 'hsla(18, 100%, 41%, 0.25)', 'hsla(18, 100%, 41%, 0.5)', 'hsla(18, 100%, 41%, 0.75)', 'hsla(18, 100%, 41%, 1)', 'hsla(18, 100%, 43%, 1)', 'hsla(18, 100%, 45%, 1)', 'hsla(18, 100%, 47%, 1)', 'hsla(18, 100%, 49%, 1)', 'hsla(18, 100%, 52%, 1)', 'hsla(18, 100%, 54%, 1)', 'hsla(18, 100%, 56%, 1)', 'hsla(18, 100%, 58%, 1)', 'hsla(18, 100%, 60%, 1)', 'hsla(250, 50%, 90%, 1)', 'hsla(250, 50%, 95%, 1)', 'hsla(249, 52%, 95%, 0.75)', 'hsla(249, 52%, 95%, 0.5)', 'hsla(249, 52%, 95%, 0.25)', 'hsla(249, 52%, 95%, 0)', 'hsla(12, 33%, 25%, 1)']

}
const templates = {
  "base": { "accentBackground": 0, "accentColor": 0, "background0": 1, "background025": 2, "background05": 3, "background075": 4, "color1": 5, "color2": 6, "color3": 7, "color4": 8, "color5": 9, "color6": 10, "color7": 11, "color8": 12, "color9": 13, "color10": 14, "color11": 15, "color12": 16, "color0": -1, "color025": -2, "color05": -3, "color075": -4, "background": 5, "backgroundHover": 4, "backgroundPress": 6, "backgroundFocus": 6, "borderColor": 8, "borderColorHover": 7, "borderColorPress": 9, "borderColorFocus": 8, "color": -5, "colorHover": -6, "colorPress": -5, "colorFocus": -6, "colorTransparent": -1, "placeholderColor": -8, "outlineColor": -2 }
  ,
